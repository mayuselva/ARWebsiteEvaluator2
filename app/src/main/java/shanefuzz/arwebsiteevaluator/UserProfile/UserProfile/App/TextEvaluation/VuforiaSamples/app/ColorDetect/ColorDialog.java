...
/**
 * Created by Prabhath on 11/19/2016.
 */
...
public class ColorDialog {
     ...
     */
    public ColorDialog(final Context context, int color, OnAmbilWarnaListener listener) {
     ...
     * @param listener an OnAmbilWarnaListener, allowing you to get back error or OK
     */
    public ColorDialog(final Context context, int color, boolean supportsAlpha, OnAmbilWarnaListener listener) {
        ...
        viewSatVal = (ColorSquare) view.findViewById(R.id.ambilwarna_viewSatBri);
